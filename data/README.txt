...
Table Ids - Table ids are created automatically. Their values do not need to be inserted into the table.
...
BEGIN
IF
DATE(DATE_ADD((SELECT D.dateCreated, INTERVAL 7 DAY)) > CURRENT_TIMESTAMP
